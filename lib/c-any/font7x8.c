...
/* System 7x8 (char 0 .. #32 to #127) */

#include <fonts.h>

static const unsigned char fontData[128 * 7]= {
...
static const Gfxmono imageBuffer = {
	sizeof fontData /7*8, 8,  8,1,  (void*) fontData
};

static CharLocation  charLocation(char c) {
	const CharLocation charLocation = { c*7, 0, 7 };

	return charLocation;
}

static CharLocation charLocationV(char c) {
	return fontCharLocationVariableLength(&font7x8,c,4,1);
}

const Font font7x8 = { &imageBuffer, 8, &charLocation };
const Font font7x8V = { &imageBuffer, 8, &charLocationV };
